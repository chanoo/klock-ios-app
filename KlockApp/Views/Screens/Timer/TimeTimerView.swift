        ...
        if viewModel.isLoading {
            ...
            GeometryReader { geometry in
                ZStack {
                    ...
                    if let focusTimerModel = viewModel.focusTimerModel {
                        VStack {
                            let focusTimerViewModel = FocusTimerViewModel(model: focusTimerModel)
                            FocusTimerView()
                                .matchedGeometryEffect(id: "FocusTimerView", in: viewModel.animation)
